        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                ...
                <div class="tm-footer-content-box">
                    ...
                    <p class="tm-margin-b-30">Aenean cursus tellus mauris, quis consequat mauris dapibus id. Donec
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                ...
                <div class="tm-footer-content-box">
                    ...
                    <div class="tm-margin-b-30">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-1.jpg" alt="Image" class="tm-footer-thumbnail">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-2.jpg" alt="Image" class="tm-footer-thumbnail">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-3.jpg" alt="Image" class="tm-footer-thumbnail">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-4.jpg" alt="Image" class="tm-footer-thumbnail">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-5.jpg" alt="Image" class="tm-footer-thumbnail">
                        <img src="<?=THEME_URL?>/img/tm-img-100x100-6.jpg" alt="Image" class="tm-footer-thumbnail">
                    </div>
                    <p class="tm-margin-b-20">Curabitur dui massa, aliquam quis mi sed, tempor vulputate tellus. Sed
                        vestibulum non neque.</p>
