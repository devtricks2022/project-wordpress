                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<?=THEME_URL?>/img/tm-img-310x180-1.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<?=THEME_URL?>/img/tm-img-310x180-2.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<?=THEME_URL?>/img/tm-img-310x180-3.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<?=THEME_URL?>/img/tm-img-310x180-4.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                ...
                <div class="row tm-margin-t-big">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="tm-2-col-left">
                            ...
                            <img src="<?=THEME_URL?>/img/tm-img-660x330-1.jpg" alt="Image" class="tm-margin-b-40 img-fluid">
                            <p>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<?=THEME_URL?>/img/tm-img-240x120-1.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<?=THEME_URL?>/img/tm-img-240x120-2.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<?=THEME_URL?>/img/tm-img-240x120-3.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
